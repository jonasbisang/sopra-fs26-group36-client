...
|                     | 11.05.2026   | https://github.com/jonasbisang/sopra-fs26-group36-client/commit/4ddeb3d7811a6faa5bf77bba3150ed9034dc01e9 , https://github.com/jonasbisang/sopra-fs26-group36-client/commit/a46a500fc09dcbb6fe534c623faea757cfcc0199 | create activity form; duration must be <= time window | logic, also TA feedback |
...
## Contributions Week 7 - 14.05.2026 to 20.05.2026
| **Student**        | **Date** | **Link to Commit** | **Description**                 | **Relevance**                       |
| ------------------ | -------- | ------------------ | ------------------------------- | ----------------------------------- |
| all teammates        | -   | - | took joker | - |